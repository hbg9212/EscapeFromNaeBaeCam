...
public class CharacterStatsHandler : MonoBehaviour
{
    ...
    private void UpdateCharacterStats()
    {
        ...
        foreach (CharacterStats modifier in statsModifiers.OrderBy(o => o.type))
        {
            if (modifier.type == StatsChangeType.Override)
            {
                UpdateStats((o, o1) => o1, modifier);
            }
            else if (modifier.type == StatsChangeType.Add)
            {
                UpdateStats((o, o1) => o + o1, modifier);
            }
            else if (modifier.type == StatsChangeType.Multiple)
            {
                UpdateStats((o, o1) => o * o1, modifier);
            }
        }
